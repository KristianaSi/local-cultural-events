...
import com.kristiana.infrastructure.persistence.exception.EntityMappingException;
...
public abstract class GenericRepository<T, ID> implements Repository<T, ID> {
    ...
    protected long executeCountQuery(String sql, List<Object> params) {
        try (Connection connection = connectionPool.getConnection();
            ...
            throw new RuntimeException("Помилка виконання count-запиту: " + sql, e);
        }
